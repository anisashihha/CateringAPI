  ...
  public function __construct() {
    ...
    public function menu_select($idtenant) {
      ...
      foreach ($query->result_array() as $row) {
            $temp = array('idmenu' => $row['idmenu'], 'idtenant' => $row['idtenant'], 'menu' => $row['menu'], 'price' => $row['price'], 'linkcatalog' => $row['linkcatalog'], 'filesize' => filesize($row['linkcatalog'])); // access attributes
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
        public function insert_menu($idtenant, $menu, $price, $linkcatalog, $filename, $filesize) {
