...
//example link result --> http://innodev.vnetcloud.com/LiveInWeb/admin/sendmailactivation?email=mail@email.com&name=mailname
$config['base_thirdapi_activate'] = array(
    'email' => '?email=',           //email langsung disambung otomatis oleh API
    'name' => '&name='              //name langsung disambung otomatis oleh API
);

//example link result --> http://innodev.vnetcloud.com/LiveInWeb/admin/sendmailactivation?email=mail@email.com&name=mailname
$config['base_thirdapi_forget'] = array(
    'phonenumber' => '?phonenumber=',           //email langsung disambung otomatis oleh API
);
